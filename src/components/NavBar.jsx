...
export default function Navbar() {
  ...
  const linkStyle = "font-sans text-sm font-semibold tracking-wider transition-colors hover:opacity-70 no-underline";
  ...
  return (
    ...
    >
      ...
      <div className="w-full px-8 md:px-12 h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <Link to="/home" className="flex items-center gap-3 no-underline">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-sans text-[10px] tracking-widest mt-1 hidden sm:block" style={{ color: muted }}>
                Generations Empowerment Movement
              </span>
            </div>
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-10">
          ...
          <div className="relative group h-20 flex items-center">
            ...
            {/* Dropdown Menu */}
            <div className="absolute top-20 left-0 w-48 bg-white border border-[#F0E4E8] shadow-xl rounded-b-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
              <Link to="/chapters" className="block px-6 py-4 hover:bg-[#FFFAF8] transition-colors no-underline font-sans text-sm font-semibold" style={{ color: charcoal }}>
                Chapters
              </Link>
              <Link to="/volunteer" className="block px-6 py-4 hover:bg-[#FFFAF8] transition-colors no-underline font-sans text-sm font-semibold" style={{ color: charcoal }}>
                Volunteer
              </Link>
            </div>
          </div>
          ...
          <Link
            to="/donate"
            className="px-8 py-3 rounded-full font-sans text-sm font-bold tracking-wider text-white no-underline transition-transform hover:scale-105"
      ...
      {mobileMenuOpen && (
        <div
          className="absolute top-full left-0 w-full md:hidden flex flex-col p-8 space-y-6 shadow-xl border-t border-[#F0E4E8]"
